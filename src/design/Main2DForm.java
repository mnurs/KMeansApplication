 ...
 * @author Saiful
 */
public class Main2DForm extends javax.swing.JFrame {

//Number of Clusters. This metric should be related to the number of titiks
    private int typeCluster = 2; 
...
//    		Titik centroid = Titik.createRandomTitik(koordinatMin,koordinatMax);
    ...
    private List<Titik> getCentroids() {
    	...
    	for(Cluster cluster : clusters) {
    		...
    		Titik titik = new Titik(aux.getX(),aux.getY());
    		centroids.add(titik);
    	}
    	return centroids;
    }
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(795, 600));
        ...
        jScrollPane1.setBounds(510, 210, 242, 141);

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel1.setText("Jumlah Cluster");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(80, 80, 84, 14);
        ...
        btnGenerate.setBounds(80, 150, 100, 23);

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel6.setText("Hasil Cluster");
        getContentPane().add(jLabel6);
        jLabel6.setBounds(20, 360, 70, 14);
        ...
        jLabel7.setBounds(20, 190, 60, 14);
        ...
        jScrollPane3.setBounds(20, 210, 477, 143);

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel8.setText("Centroid Awal");
        getContentPane().add(jLabel8);
        jLabel8.setBounds(510, 190, 78, 14);
        ...
        jButton1.setBounds(200, 150, 100, 23);
        ...
        jButton2.setBounds(320, 150, 100, 23);
...
//        Plot3DPanel plot = new Plot3DPanel(); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Main2DForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
